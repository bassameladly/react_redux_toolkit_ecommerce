              ...
              <div className="product-details font-manrope">
                ...
                <div className="info flex align-center flex-wrap fs-14">
                  <div className="rating">
                    <span className="text-purple fw-5">Rating:</span>
                    <span className="mx-1">{product?.rating}</span>
                  </div>
                  <div className="vert-line"></div>
                  <div className="brand">
                    <span className="text-purple fw-5">Brand:</span>
                    <span className="mx-1">{product?.brand}</span>
                  </div>
                  <div className="vert-line"></div>
                  <div className="brand">
                    <span className="text-purple fw-5">Category:</span>
                ...
                <div className="price">
                  ...
                  <div className="flex align-center my-1">
                    <div className="new-price fw-5 font-poppins fs-24 text-purple">
                ...
                <div className="qty flex align-center my-4">
                  ...
                  {product?.stock === 0 ? (
                    <div className="qty-error text-uppercase bg-purple text-white fs-12 ls-1 mx-2 fw-5">
                      out of stock
                    </div>
                  ) : (
                    ""
